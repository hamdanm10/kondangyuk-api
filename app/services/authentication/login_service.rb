  ...
  class LoginService < BaseService
    ...
    def call
      ...
      unless authenticated
        return ServiceResult.failure(credentials: [ I18n.t("messages.errors.invalid_credentials") ])
      end
      ...
      unless user.is_active?
        return ServiceResult.failure(account: [ I18n.t("messages.errors.account_deactivated") ])
      end
