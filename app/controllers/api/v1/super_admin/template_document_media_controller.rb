module Api
  module V1
    class SuperAdmin::TemplateDocumentMediaController < Api::V1::SuperAdmin::BaseController
      def index
      ...
      def document
        @document ||= TemplateDocuments::ShowService.call(template_id: params[:template_id]).data[:document]
      end
