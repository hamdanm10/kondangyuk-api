...
RSpec.describe 'API V1 Admin Profile', type: :request do
  path '/api/v1/admin/profile' do
    get 'Get own profile' do
      tags        'Admin | Profiles'
      produces    'application/json'
      description 'Returns the authenticated user profile. Accessible by admin only.'
      security    [ cookieAuth: [] ]
      ...
      response '403', 'forbidden — non-admin role cannot access' do
